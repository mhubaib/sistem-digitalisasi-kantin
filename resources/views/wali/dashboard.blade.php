...
@section('content')
    <div class="max-w-screen mx-auto py-4">
        ...
        <div class="relative mb-8">
            ...
            <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-green-100 shadow-xl">
                <div class="flex items-center justify-between">
                    <div>
                        <h1
                            class="text-3xl font-bold bg-gradient-to-r from-green-700 to-green-900 bg-clip-text text-transparent">
                                ...
                                @forelse ($santris as $santri)
                                    <tr class="hover:bg-green-50/50 transition-colors duration-200">
                                        <td class="py-4 px-2">
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    class="w-10 h-10 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                        ...
                                        <td class="py-4 px-2">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                @if ($santri->saldo > 50000)
                                                    <span
                                                        class="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-medium">Baik</span>
                                                @elseif($santri->saldo > 10000)
                                                    <span
                                                        class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs font-medium">Cukup</span>
                                                @else
                                                    <span
                                                        class="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs font-medium">Rendah</span>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3" class="py-12 text-center">
                                            <div class="flex flex-col items-center space-y-3">
                                                ...
                                                <p class="text-sm text-gray-400">Data santri akan muncul setelah didaftarkan
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                @forelse ($recentTransactions as $trx)
                                    <tr class="hover:bg-blue-50/50 transition-colors duration-200">
                                        <td class="py-4 px-2">
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    class="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-500 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                                    {{ strtoupper(substr($trx->santri->user->name ?? 'N/A', 0, 2)) }}
                                                </div>
                                                <div>
                                                    <p class="font-medium text-gray-800">
                                                        {{ $trx->santri->user->name ?? '-' }}</p>
