...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            z-index: 50; /* Above content but below overlay */
        }
        ...
        .sidebar-icon-only + .navbar {
            left: 70px; /* Adjust for icon-only sidebar */
        }
        
        .sidebar-hidden + .navbar {
            left: 0; /* No offset when sidebar is hidden */
        }
        ...
        .main-content {
            ...
            min-height: calc(100vh - 4rem); /* Ensure it takes at least full height minus navbar */
        }
        ...
        @media (max-width: 768px) {
            ...
            .content-wrapper {
                ...
                margin-top: 7rem; /* Keep navbar offset */
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleSidebar() {
                ...
                if (isMobile) {
                    ...
                    contentWrapper.style.marginLeft = sidebar.classList.contains('sidebar-icon-only') ? '70px' : '16rem';
                }
            }
