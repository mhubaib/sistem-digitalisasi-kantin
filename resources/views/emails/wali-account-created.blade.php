    ...
    <style>
        * {
        ...
        .credentials-card::before {
            ...
            width: 4px;
            height: 100%;
            background: linear-gradient(to bottom, #6a4c93, #9b59b6);
        }
        ...
        <div class="content">
            ...
            <div class="credentials-card">
                ...
                <div class="credential-item">
                    <div class="credential-label">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 8px;">
                            <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="#666666" stroke-width="2"/>
                            <path d="M22 6L12 13L2 6" stroke="#666666" stroke-width="2"/>
                        </svg>
                        Email:
                    </div>
                ...
                <div class="credential-item">
                    <div class="credential-label">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 8px;">
                            <path d="M9 12C9 13.3807 10.1193 14.5 11.5 14.5C12.8807 14.5 14 13.3807 14 12C14 10.6193 12.8807 9.5 11.5 9.5C10.1193 9.5 9 10.6193 9 12Z" stroke="#666666" stroke-width="2"/>
                            <path d="M21 12C18.6 16 15.4 18 12 18C8.6 18 5.4 16 3 12C5.4 8 8.6 6 12 6C15.4 6 18.6 8 21 12Z" stroke="#666666" stroke-width="2"/>
                        </svg>
                        Password:
                    </div>
            ...
            <div class="warning-box">
                <h3>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 8px;">
                        <path d="M12 9V13M12 17H12.01M10.29 3.86L1.82 18A2 2 0 0 0 3.64 21H20.36A2 2 0 0 0 22.18 18L13.71 3.86A2 2 0 0 0 10.29 3.86Z" stroke="#856404" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Keamanan Akun
                </h3>
                <p><strong>Penting:</strong>Pastikan untuk menjaga kerahasiaan akun Anda dan jangan berbagi informasi login dengan orang lain. Jika mengalami kesulitan dalam mengakses akun, silakan hubungi tim support kami.</p>
            </div>
