                ...
                <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 p-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="hidden md:block">
                            <div
                                class="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                ...
                <div class="p-8 md:p-10">
                    ...
                    <form action="{{ route('admin.topup.store') }}" method="POST" class="space-y-8">
                        ...
                        <div
                            ...
                            <div
                                class="text-sm text-gray-600 flex items-center w-full sm:w-auto justify-center sm:justify-start mb-4 sm:mb-0">
                            ...
                            <div class="flex gap-4 w-full sm:w-auto justify-center">
                                <a href="{{ route('admin.topup.index') }}"
                                    class="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-300 font-semibold border border-gray-200 hover:border-gray-300 inline-flex items-center justify-center min-h-[54px] w-full sm:w-auto">
                                    <i class="fas fa-arrow-left mr-2"></i>
                                    Kembali
                                </a>

                                <button type="submit"
                                    class="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 font-semibold group inline-flex items-center justify-center min-h-[54px] w-full sm:w-auto">
                                    <i
