        ...
        <div class="bg-gradient-to-br from-gray-800 to-gray-600 rounded-xl p-6 mb-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-blue-100">Ubah informasi pengeluaran kantin</p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="category"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 appearance-none @error('category') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="payment_method"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none @error('payment_method') border-red-500 @enderror">
