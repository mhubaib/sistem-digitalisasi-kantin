                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select name="payment_type"
                                ...
                                <option value="saldo" {{ request('payment_type') == 'saldo' ? 'selected' : '' }}>Saldo
                                    Digital</option>
                                <option value="cash" {{ request('payment_type') == 'cash' ? 'selected' : '' }}>Tunai
                                </option>
                            </select>
                            <i
                                class="fas fa-chevron-down absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-sm pointer-events-none"></i>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100/50 border border-yellow-200/50 rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-light text-yellow-800">Rp
                            {{ number_format($totalIncome - $totalExpenses, 0, ',', '.') }}</p>
                    </div>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-500 text-sm">Belum ada data transaksi yang tersedia saat ini.
                                        </p>
                                    </div>
                                </td>
                            </tr>
