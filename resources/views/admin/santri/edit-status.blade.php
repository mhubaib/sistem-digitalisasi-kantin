                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        <li class="inline-flex items-center">
                            <a href="{{ route('admin.dashboard') }}"
                                ...
                                <div class="w-8 h-8 rounded-lg bg-gray-100 group-hover:bg-blue-100 flex items-center justify-center mr-2 transition-all duration-300">
                        ...
                        <li>
                            <div class="flex items-center">
                                <i class="fas fa-chevron-right text-gray-300 mx-2 text-xs"></i>
                                <span class="text-sm font-medium text-slate-800 px-2.5 py-1 bg-blue-100 rounded-full">Update Status</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-2">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                        ...
                        <p class="text-slate-600 text-sm font-medium">Kelola status aktif/non-aktif santri dengan mudah dan aman</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-1">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                    ...
                    <div class="p-8">
                        <form action="{{ route('admin.santri.status.update', $santri->id) }}" method="POST" class="space-y-8">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div class="group">
                                        <div class="bg-gradient-to-br from-blue-50/50 to-indigo-50/30 border border-blue-200/40 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:border-blue-300/60">
                                            ...
                                            <div class="space-y-4">
                                                <div class="group/item">
                                                    <label class="block text-sm font-semibold text-slate-600 mb-1.5">Nama Santri</label>
                                                    <div class="bg-white/70 backdrop-blur-sm rounded-xl px-4 py-3 border border-slate-200/60 group-hover/item:border-blue-300/60 transition-all duration-200">
                                                        <span class="text-slate-900 font-medium">{{ $santri->user->name }}</span>
                                                    </div>
                                                </div>
                                                
                                                <div class="group/item">
                                                    <label class="block text-sm font-semibold text-slate-600 mb-1.5">Email Santri</label>
                                                    <div class="bg-white/70 backdrop-blur-sm rounded-xl px-4 py-3 border border-slate-200/60 group-hover/item:border-blue-300/60 transition-all duration-200">
                                                        <span class="text-slate-900 font-medium">{{ $santri->user->email }}</span>
                                                    </div>
                                                </div>
                                                
                                                <div class="group/item">
                                                    <label class="block text-sm font-semibold text-slate-600 mb-1.5">ID Santri</label>
                                                    <div class="bg-white/70 backdrop-blur-sm rounded-xl px-4 py-3 border border-slate-200/60 group-hover/item:border-blue-300/60 transition-all duration-200">
                                                ...
                                                <div class="group/item">
                                                    <label class="block text-sm font-semibold text-slate-600 mb-1.5">Saldo Tersedia</label>
                                                    <div class="bg-gradient-to-r from-emerald-50 to-teal-50 backdrop-blur-sm rounded-xl px-4 py-3 border border-emerald-200/60 group-hover/item:border-emerald-300/80 transition-all duration-200">
                                    ...
                                    <div class="space-y-6">
                                        <!-- Wali Information -->
                                        <div class="group">
                                            <div class="bg-gradient-to-br from-emerald-50/50 to-teal-50/30 border border-emerald-200/40 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:border-emerald-300/60">
                                                <div class="flex items-center space-x-3 mb-5">
                                                    <div class="w-10 h-10 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 flex items-center justify-center shadow-md">
                                                ...
                                                <div class="space-y-4">
                                                    <div class="group/item">
                                                        ...
                                                        <div class="bg-white/70 backdrop-blur-sm rounded-xl px-4 py-3 border border-slate-200/60 group-hover/item:border-emerald-300/60 transition-all duration-200">
                                                            <span class="text-slate-900 font-medium">{{ $santri->wali->name ?? 'Belum Terdaftar' }}</span>
                                                        </div>
                                                    </div>
                                                    
                                                    <div class="group/item">
                                                        <label class="block text-sm font-semibold text-slate-600 mb-1.5">Email Wali</label>
                                                        <div class="bg-white/70 backdrop-blur-sm rounded-xl px-4 py-3 border border-slate-200/60 group-hover/item:border-emerald-300/60 transition-all duration-200">
                                                            <span class="text-slate-900 font-medium">{{ $santri->wali->email ?? 'Belum Terdaftar' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="group">
                                            <div class="bg-gradient-to-br from-purple-50/50 to-indigo-50/30 border border-purple-200/40 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:border-purple-300/60">
                                                <div class="flex items-center space-x-3 mb-5">
                                                ...
                                                <div class="flex justify-center">
                                                    @if ($santri->user->active)
                                                        <div class="inline-flex items-center px-6 py-3 rounded-2xl text-sm font-bold bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg">
                                                            <div class="w-3 h-3 bg-white rounded-full mr-3 animate-pulse"></div>
                                                            <i class="fas fa-check-circle mr-2"></i>
                                                            Status Aktif
                                                        </div>
                                                    @else
                                                        <div class="inline-flex items-center px-6 py-3 rounded-2xl text-sm font-bold bg-gradient-to-r from-red-500 to-rose-600 text-white shadow-lg">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center space-x-3 mb-6">
                                    <div class="w-8 h-8 rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 flex items-center justify-center">
                                        <i class="fas fa-edit text-white text-sm"></i>
                                    </div>
                                    <h3 class="text-xl font-semibold text-slate-800">Perubahan Status</h3>
                                </div>

                                <div class="bg-gradient-to-br from-slate-50/50 to-gray-50/30 border border-slate-200/40 rounded-2xl p-8">
                                    <div class="space-y-6">
                                        <p class="text-slate-600 text-center font-medium mb-8">Pilih status baru untuk santri ini</p>
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        <div class="flex-1">
                                                            <div class="flex items-center space-x-3 mb-2">
                                                                ...
                                                                <span class="text-lg font-bold text-slate-800">Status Aktif</span>
                                                            </div>
                                                            <p class="text-sm text-slate-600">Santri dapat mengakses semua fitur sistem</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <label for="status_inactive" class="group cursor-pointer">
                                                <div class="relative bg-white border-2 border-red-200 rounded-2xl p-3 transition-all duration-300 hover:border-red-400 hover:shadow-lg {{ !$santri->user->active ? 'border-red-400 bg-red-50/50 shadow-lg' : '' }}">
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        <div class="flex-1">
                                                            <div class="flex items-center space-x-3 mb-2">
                                                                <div class="w-10 h-10 rounded-xl bg-gradient-to-r from-red-500 to-rose-600 flex items-center justify-center shadow-md">
                                                                    <i class="fas fa-times-circle text-white"></i>
                                                                </div>
                                                                <span class="text-lg font-bold text-slate-800">Status Non Aktif</span>
                                                            </div>
                                                            <p class="text-sm text-slate-600">Santri tidak dapat mengakses sistem</p>
                                                        </div>
                                                    </div>
